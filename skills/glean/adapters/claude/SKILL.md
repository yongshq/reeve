---
name: glean
description: End of session sweep: harvest what was actually learned, then report the budget.
user-invocable: true
allowed-tools: Bash, Read, Glob, Grep, Write, Edit
---

<!-- GENERATED by bin/reeve-adapters. Edit skills/glean/glean.md instead. -->
