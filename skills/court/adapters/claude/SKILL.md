---
name: court
description: Recap where the household stands, then settle whatever is waiting on the liege, one question at a time.
user-invocable: true
allowed-tools: Bash, Read, Glob, Grep, Write, Edit
---

<!-- GENERATED by bin/reeve-adapters. Edit skills/court/court.md instead. -->
