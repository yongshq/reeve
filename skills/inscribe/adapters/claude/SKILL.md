---
name: inscribe
description: Record something the liege told you to remember, in the right scope and tier.
user-invocable: true
allowed-tools: Bash, Read, Glob, Grep, Write, Edit
---

<!-- GENERATED by bin/reeve-adapters. Edit skills/inscribe/inscribe.md instead. -->
