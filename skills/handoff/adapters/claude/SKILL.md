---
name: handoff
description: Write down the part of this session that will not survive a reset, so the next reeve resumes instead of restarting.
user-invocable: true
allowed-tools: Bash, Read, Glob, Grep, Write, Edit
---

<!-- GENERATED by bin/reeve-adapters. Edit skills/handoff/handoff.md instead. -->
